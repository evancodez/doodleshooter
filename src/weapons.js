...
const GUNS = {
  rifle: { name: 'RIFLE', hint: 'auto · aim for the holo sight', kind: 'rifle', magSize: 35, reserve: 175, maxReserve: 350, interval: 1 / 11, damage: 24, headMul: 2.6, pellets: 1, spread: 0.018, adsSpread: 0.004, spreadKick: 0.011, spreadMax: 0.09, adsFov: 58, sight: [0, 0.12, -0.05, 0.3], camKick: [0.011, 0.004], modelKick: [0.25, 0.3, 2.4, -3.2, 0.9, 1.2], fovKick: 1.2, reloadDur: 1.45, reloadType: 'mag', auto: true, falloff: null, tracer: 0.02, flashScale: 1, sound: 'shot', shell: [0.02, INK.ORANGE], moveSpread: 0.0012, pvp: [19, 1.8, null] },
  shotgun: { name: 'SHOTGUN', hint: 'pump · devastating up close', kind: 'shotgun', magSize: 6, reserve: 36, maxReserve: 72, interval: 0.78, damage: 15, headMul: 1.8, pellets: 10, spread: 0.062, adsSpread: 0.034, spreadKick: 0, spreadMax: 0.1, adsFov: 68, sight: [0, 0.095, -1.0, 0.52], camKick: [0.05, 0.012], modelKick: [0.4, 0.6, 5, -9, 2, 3], fovKick: 4, reloadDur: 0.45, reloadType: 'shells', auto: false, falloff: [11, 32, 0.28], tracer: 0.014, flashScale: 1.9, sound: 'shotgunFire', shell: [0.035, INK.RED], moveSpread: 0.0006, cycleDur: 0.45, pvp: [12, 1.6, [9, 26, 0.2]] },
...
export class Rifle extends Gun {
  ...
  build() {
    ...
    // a fine ring and a pin-prick dot: small enough that the target stays visible through it
    const ret = new THREE.Mesh(new THREE.TorusGeometry(0.0075, 0.0018, 5, 14), this.red); ret.position.set(0, 0.12, -0.05); g.add(ret); sph(0.0022, 0, 0.12, -0.05, this.red, g, 5);
